<nav x-data="{ mobileMenuOpen: false }" 
    ...
    <div x-show="mobileMenuOpen" 
        ...
        <div class="space-y-1">
            ...
            @if ($isSuperAdmin)
                <a href="{{ route('admin.dashboard') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-2xl text-sm font-semibold transition min-h-[44px] {{ request()->routeIs('admin.dashboard') ? 'bg-blue-50 text-blue-600 font-bold' : 'text-slate-700 hover:bg-slate-50' }}">
                    <div class="w-8 h-8 rounded-xl flex items-center justify-center shrink-0 {{ request()->routeIs('admin.dashboard') ? 'bg-blue-600 text-white' : 'bg-slate-100 text-slate-500' }}">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"/></svg>
                    </div>
                    <span>Dashboard</span>
                </a>
                <a href="{{ route('admin.applications.index') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-2xl text-sm font-semibold transition min-h-[44px] {{ request()->routeIs('admin.applications.*') ? 'bg-blue-50 text-blue-600 font-bold' : 'text-slate-700 hover:bg-slate-50' }}">
                    <div class="w-8 h-8 rounded-xl flex items-center justify-center shrink-0 {{ request()->routeIs('admin.applications.*') ? 'bg-blue-600 text-white' : 'bg-slate-100 text-slate-500' }}">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/></svg>
                    </div>
                    <span>Pengajuan</span>
                </a>
                <a href="{{ route('admin.agencies.index') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-2xl text-sm font-semibold transition min-h-[44px] {{ request()->routeIs('admin.agencies.*') || request()->routeIs('admin.units.*') ? 'bg-blue-50 text-blue-600 font-bold' : 'text-slate-700 hover:bg-slate-50' }}">
                    <div class="w-8 h-8 rounded-xl flex items-center justify-center shrink-0 {{ request()->routeIs('admin.agencies.*') || request()->routeIs('admin.units.*') ? 'bg-blue-600 text-white' : 'bg-slate-100 text-slate-500' }}">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4"/></svg>
                    </div>
                    <span>Instansi Dinas</span>
                </a>
                <a href="{{ route('admin.universities.index') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-2xl text-sm font-semibold transition min-h-[44px] {{ request()->routeIs('admin.universities.*') ? 'bg-blue-50 text-blue-600 font-bold' : 'text-slate-700 hover:bg-slate-50' }}">
                    <div class="w-8 h-8 rounded-xl flex items-center justify-center shrink-0 {{ request()->routeIs('admin.universities.*') ? 'bg-blue-600 text-white' : 'bg-slate-100 text-slate-500' }}">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 14l9-5-9-5-9 5 9 5zm0 0l6.16-3.422a12.083 12.083 0 01.665 6.479A11.952 11.952 0 0012 20.055a11.952 11.952 0 00-6.824-2.998 12.078 12.078 0 01.665-6.479L12 14zm-4 6v-7.5l4-2.222"/></svg>
                    </div>
                    <span>Perguruan Tinggi</span>
                </a>
                <a href="{{ route('admin.users.index') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-2xl text-sm font-semibold transition min-h-[44px] {{ request()->routeIs('admin.users.*') ? 'bg-blue-50 text-blue-600 font-bold' : 'text-slate-700 hover:bg-slate-50' }}">
                    <div class="w-8 h-8 rounded-xl flex items-center justify-center shrink-0 {{ request()->routeIs('admin.users.*') ? 'bg-blue-600 text-white' : 'bg-slate-100 text-slate-500' }}">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z"/></svg>
                    </div>
                    <span>Semua Pengguna</span>
                </a>
                <a href="{{ route('admin.mentors.index') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-2xl text-sm font-semibold transition min-h-[44px] {{ request()->routeIs('admin.mentors.*') ? 'bg-blue-50 text-blue-600 font-bold' : 'text-slate-700 hover:bg-slate-50' }}">
                    <div class="w-8 h-8 rounded-xl flex items-center justify-center shrink-0 {{ request()->routeIs('admin.mentors.*') ? 'bg-blue-600 text-white' : 'bg-slate-100 text-slate-500' }}">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 13.255A23.931 23.931 0 0112 15c-3.183 0-6.22-.62-9-1.745M16 6V4a2 2 0 00-2-2h-4a2 2 0 00-2 2v2m4 6h.01M5 20h14a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"/></svg>
                    </div>
            ...
            @elseif ($isAdminDinas)
                ...
                <a href="{{ route('admin.units.index') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-2xl text-sm font-semibold transition min-h-[44px] {{ request()->routeIs('admin.units.*') ? 'bg-blue-50 text-blue-600 font-bold' : 'text-slate-700 hover:bg-slate-50' }}">
                    <div class="w-8 h-8 rounded-xl flex items-center justify-center shrink-0 {{ request()->routeIs('admin.units.*') ? 'bg-blue-600 text-white' : 'bg-slate-100 text-slate-500' }}">
                ...
                <a href="{{ route('admin.logbooks.index') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-2xl text-sm font-semibold transition min-h-[44px] {{ request()->routeIs('admin.logbooks.*') ? 'bg-blue-50 text-blue-600 font-bold' : 'text-slate-700 hover:bg-slate-50' }}">
                    <div class="w-8 h-8 rounded-xl flex items-center justify-center shrink-0 {{ request()->routeIs('admin.logbooks.*') ? 'bg-blue-600 text-white' : 'bg-slate-100 text-slate-500' }}">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253"/></svg>
                    </div>
                    <span>Monitoring Logbook</span>
                </a>
                <a href="{{ route('admin.certificates.index') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-2xl text-sm font-semibold transition min-h-[44px] {{ request()->routeIs('admin.certificates.*') ? 'bg-blue-50 text-blue-600 font-bold' : 'text-slate-700 hover:bg-slate-50' }}">
                    <div class="w-8 h-8 rounded-xl flex items-center justify-center shrink-0 {{ request()->routeIs('admin.certificates.*') ? 'bg-blue-600 text-white' : 'bg-slate-100 text-slate-500' }}">
                ...
                <a href="{{ route('admin.agency_profile.edit') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-2xl text-sm font-semibold transition min-h-[44px] {{ request()->routeIs('admin.agency_profile.*') ? 'bg-blue-50 text-blue-600 font-bold' : 'text-slate-700 hover:bg-slate-50' }}">
                    <div class="w-8 h-8 rounded-xl flex items-center justify-center shrink-0 {{ request()->routeIs('admin.agency_profile.*') ? 'bg-blue-600 text-white' : 'bg-slate-100 text-slate-500' }}">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4"/></svg>
                    </div>
            ...
            @elseif ($isMahasiswa)
                <a href="{{ route('dashboard') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-2xl text-sm font-semibold transition min-h-[44px] {{ request()->routeIs('dashboard') ? 'bg-blue-50 text-blue-600 font-bold' : 'text-slate-700 hover:bg-slate-50' }}">
                    <div class="w-8 h-8 rounded-xl flex items-center justify-center shrink-0 {{ request()->routeIs('dashboard') ? 'bg-blue-600 text-white' : 'bg-slate-100 text-slate-500' }}">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"/></svg>
                    </div>
                    <span>Dashboard Saya</span>
                </a>
                <a href="{{ route('student.profile.edit') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-2xl text-sm font-semibold transition min-h-[44px] {{ request()->routeIs('student.profile.*') ? 'bg-blue-50 text-blue-600 font-bold' : 'text-slate-700 hover:bg-slate-50' }}">
                    <div class="w-8 h-8 rounded-xl flex items-center justify-center shrink-0 {{ request()->routeIs('student.profile.*') ? 'bg-blue-600 text-white' : 'bg-slate-100 text-slate-500' }}">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"/></svg>
                    </div>
                    <span>Profil Saya</span>
                </a>
                <a href="{{ route('student.application.create') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-2xl text-sm font-semibold transition min-h-[44px] {{ request()->routeIs('student.application.*') ? 'bg-blue-50 text-blue-600 font-bold' : 'text-slate-700 hover:bg-slate-50' }}">
                    <div class="w-8 h-8 rounded-xl flex items-center justify-center shrink-0 {{ request()->routeIs('student.application.*') ? 'bg-blue-600 text-white' : 'bg-slate-100 text-slate-500' }}">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v3m0 0v3m0-3h3m-3 0H9m12 0a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
                    </div>
                    <span>Pengajuan Magang</span>
                </a>
                <a href="{{ route('student.logbook.index') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-2xl text-sm font-semibold transition min-h-[44px] {{ request()->routeIs('student.logbook.*') ? 'bg-blue-50 text-blue-600 font-bold' : 'text-slate-700 hover:bg-slate-50' }}">
                    <div class="w-8 h-8 rounded-xl flex items-center justify-center shrink-0 {{ request()->routeIs('student.logbook.*') ? 'bg-blue-600 text-white' : 'bg-slate-100 text-slate-500' }}">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253"/></svg>
                    </div>
                    <span>Logbook Magang</span>
                </a>
                <a href="{{ route('student.final_report.index') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-2xl text-sm font-semibold transition min-h-[44px] {{ request()->routeIs('student.final_report.*') ? 'bg-blue-50 text-blue-600 font-bold' : 'text-slate-700 hover:bg-slate-50' }}">
                    <div class="w-8 h-8 rounded-xl flex items-center justify-center shrink-0 {{ request()->routeIs('student.final_report.*') ? 'bg-blue-600 text-white' : 'bg-slate-100 text-slate-500' }}">
            ...
            @elseif ($isDosen)
                <a href="{{ route('lecturer.dashboard') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-2xl text-sm font-semibold transition min-h-[44px] {{ request()->routeIs('lecturer.dashboard') ? 'bg-blue-50 text-blue-600 font-bold' : 'text-slate-700 hover:bg-slate-50' }}">
                    <div class="w-8 h-8 rounded-xl flex items-center justify-center shrink-0 {{ request()->routeIs('lecturer.dashboard') ? 'bg-blue-600 text-white' : 'bg-slate-100 text-slate-500' }}">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"/></svg>
                    </div>
                    <span>Portal Dosen</span>
                </a>
                <a href="{{ route('lecturer.monitoring.index') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-2xl text-sm font-semibold transition min-h-[44px] {{ request()->routeIs('lecturer.monitoring.*') ? 'bg-blue-50 text-blue-600 font-bold' : 'text-slate-700 hover:bg-slate-50' }}">
                    <div class="w-8 h-8 rounded-xl flex items-center justify-center shrink-0 {{ request()->routeIs('lecturer.monitoring.*') ? 'bg-blue-600 text-white' : 'bg-slate-100 text-slate-500' }}">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z"/></svg>
                    </div>
                    <span>Mahasiswa Bimbingan</span>
                </a>
                <a href="{{ route('lecturer.logbooks.index') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-2xl text-sm font-semibold transition min-h-[44px] {{ request()->routeIs('lecturer.logbooks.*') ? 'bg-blue-50 text-blue-600 font-bold' : 'text-slate-700 hover:bg-slate-50' }}">
                    <div class="w-8 h-8 rounded-xl flex items-center justify-center shrink-0 {{ request()->routeIs('lecturer.logbooks.*') ? 'bg-blue-600 text-white' : 'bg-slate-100 text-slate-500' }}">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253"/></svg>
                    </div>
            ...
            @elseif ($isMentor)
                <a href="{{ route('mentor.dashboard') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-2xl text-sm font-semibold transition min-h-[44px] {{ request()->routeIs('mentor.dashboard') ? 'bg-blue-50 text-blue-600 font-bold' : 'text-slate-700 hover:bg-slate-50' }}">
                    <div class="w-8 h-8 rounded-xl flex items-center justify-center shrink-0 {{ request()->routeIs('mentor.dashboard') ? 'bg-blue-600 text-white' : 'bg-slate-100 text-slate-500' }}">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"/></svg>
                    </div>
                    <span>Portal Mentor</span>
                </a>
                <a href="{{ route('mentor.logbooks.index') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-2xl text-sm font-semibold transition min-h-[44px] {{ request()->routeIs('mentor.logbooks.*') ? 'bg-blue-50 text-blue-600 font-bold' : 'text-slate-700 hover:bg-slate-50' }}">
                    <div class="w-8 h-8 rounded-xl flex items-center justify-center shrink-0 {{ request()->routeIs('mentor.logbooks.*') ? 'bg-blue-600 text-white' : 'bg-slate-100 text-slate-500' }}">
            ...
            @elseif ($isUniversitas)
                <a href="{{ route('university.dashboard') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-2xl text-sm font-semibold transition min-h-[44px] {{ request()->routeIs('university.dashboard') ? 'bg-blue-50 text-blue-600 font-bold' : 'text-slate-700 hover:bg-slate-50' }}">
                    <div class="w-8 h-8 rounded-xl flex items-center justify-center shrink-0 {{ request()->routeIs('university.dashboard') ? 'bg-blue-600 text-white' : 'bg-slate-100 text-slate-500' }}">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"/></svg>
                    </div>
                    <span>Portal Universitas</span>
                </a>
                <a href="{{ route('university.lecturers.index') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-2xl text-sm font-semibold transition min-h-[44px] {{ request()->routeIs('university.lecturers.*') ? 'bg-blue-50 text-blue-600 font-bold' : 'text-slate-700 hover:bg-slate-50' }}">
                    <div class="w-8 h-8 rounded-xl flex items-center justify-center shrink-0 {{ request()->routeIs('university.lecturers.*') ? 'bg-blue-600 text-white' : 'bg-slate-100 text-slate-500' }}">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z"/></svg>
                    </div>
                    <span>Dosen Pembimbing</span>
                </a>
                <a href="{{ route('university.profile.index') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-2xl text-sm font-semibold transition min-h-[44px] {{ request()->routeIs('university.profile.*') ? 'bg-blue-50 text-blue-600 font-bold' : 'text-slate-700 hover:bg-slate-50' }}">
                    <div class="w-8 h-8 rounded-xl flex items-center justify-center shrink-0 {{ request()->routeIs('university.profile.*') ? 'bg-blue-600 text-white' : 'bg-slate-100 text-slate-500' }}">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4"/></svg>
                    </div>
        ...
        <div class="pt-2 border-t border-slate-100 space-y-1">
            <a href="{{ route('notifications.index') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-2xl text-sm font-semibold transition min-h-[44px] {{ request()->routeIs('notifications.*') ? 'bg-blue-50 text-blue-600 font-bold' : 'text-slate-700 hover:bg-slate-50' }}">
                <div class="w-8 h-8 rounded-xl flex items-center justify-center shrink-0 {{ request()->routeIs('notifications.*') ? 'bg-blue-600 text-white' : 'bg-slate-100 text-slate-500' }}">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6.002 6.002 0 00-4-5.659V5a2 2 0 10-4 0v.341C7.67 6.165 6 8.388 6 11v3.159c0 .538-.214 1.055-.595 1.436L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9"/></svg>
                </div>
                <span>Pemberitahuan Sistem</span>
            </a>
            @if($isSuperAdmin || $isAdminDinas)
                <a href="{{ route('admin.feedbacks.index') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-2xl text-sm font-semibold transition min-h-[44px] {{ request()->routeIs('admin.feedbacks.*') ? 'bg-blue-50 text-blue-600 font-bold' : 'text-slate-700 hover:bg-slate-50' }}">
                    <div class="w-8 h-8 rounded-xl flex items-center justify-center shrink-0 {{ request()->routeIs('admin.feedbacks.*') ? 'bg-blue-600 text-white' : 'bg-slate-100 text-slate-500' }}">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 10h.01M12 10h.01M16 10h.01M9 16H5a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v8a2 2 0 01-2 2h-5l-5 5v-5z"/></svg>
                    </div>
                    <span>Feedback & Masukan</span>
                </a>
            @else
                <a href="{{ route('feedbacks.create') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-2xl text-sm font-semibold transition min-h-[44px] {{ request()->routeIs('feedbacks.create') ? 'bg-blue-50 text-blue-600 font-bold' : 'text-slate-700 hover:bg-slate-50' }}">
                    <div class="w-8 h-8 rounded-xl flex items-center justify-center shrink-0 {{ request()->routeIs('feedbacks.create') ? 'bg-blue-600 text-white' : 'bg-slate-100 text-slate-500' }}">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z"/></svg>
                    </div>
                    <span>Kirim Laporan Kendala</span>
                </a>
                <a href="{{ route('feedbacks.my') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-2xl text-sm font-semibold transition min-h-[44px] {{ request()->routeIs('feedbacks.my') ? 'bg-blue-50 text-blue-600 font-bold' : 'text-slate-700 hover:bg-slate-50' }}">
                    <div class="w-8 h-8 rounded-xl flex items-center justify-center shrink-0 {{ request()->routeIs('feedbacks.my') ? 'bg-blue-600 text-white' : 'bg-slate-100 text-slate-500' }}">
        ...
        <div class="pt-3 border-t border-slate-100">
            <form method="POST" action="{{ route('logout') }}">
                @csrf
                <button type="submit" class="w-full flex items-center justify-center gap-2 px-4 py-3 rounded-2xl text-xs font-bold text-rose-600 bg-rose-50 hover:bg-rose-100 transition cursor-pointer active:scale-[0.99] min-h-[44px]">
