            ...
            <div class="bg-white rounded-2xl border border-gray-100 shadow-xs p-6 sm:p-8">
                ...
                <form method="POST" action="{{ route('admin.users.update', $user->id) }}" class="space-y-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="name" value="{{ old('name', $user->name) }}" required class="w-full text-xs sm:text-sm border-gray-300 rounded-xl focus:ring-indigo-500 focus:border-indigo-500 shadow-2xs">
                    </div>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="email" name="email" value="{{ old('email', $user->email) }}" required class="w-full text-xs sm:text-sm border-gray-300 rounded-xl focus:ring-indigo-500 focus:border-indigo-500 shadow-2xs font-mono">
                        </div>
                        ...
                        <div>
                            ...
                            <input type="password" name="password" placeholder="Biarkan kosong jika tidak diubah" class="w-full text-xs sm:text-sm border-gray-300 rounded-xl focus:ring-indigo-500 focus:border-indigo-500 shadow-2xs font-mono">
                        </div>
                    </div>
