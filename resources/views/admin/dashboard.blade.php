<x-app-layout>
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8">
        ...
        <div class="bg-gradient-to-r from-blue-900 via-blue-800 to-indigo-900 rounded-3xl p-6 sm:p-8 text-white shadow-xl shadow-blue-950/20 relative overflow-hidden" style="background: linear-gradient(135deg, #1e3a8a 0%, #1e40af 50%, #312e81 100%) !important; color: #ffffff !important;">
            <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6 relative z-10">
                ...
                <div class="grid grid-cols-2 sm:grid-cols-4 gap-3 shrink-0">
                    <a href="{{ route('admin.agencies.index') }}" class="p-3.5 bg-white/10 hover:bg-white/20 backdrop-blur-md rounded-2xl border border-white/10 text-center transition group hover:scale-105 cursor-pointer" style="background-color: rgba(255, 255, 255, 0.15) !important; border: 1px solid rgba(255, 255, 255, 0.25) !important; color: #ffffff !important;">
                    ...
                    <a href="{{ route('admin.universities.index') }}" class="p-3.5 bg-white/10 hover:bg-white/20 backdrop-blur-md rounded-2xl border border-white/10 text-center transition group hover:scale-105 cursor-pointer" style="background-color: rgba(255, 255, 255, 0.15) !important; border: 1px solid rgba(255, 255, 255, 0.25) !important; color: #ffffff !important;">
                        <div class="text-xl mb-1 group-hover:scale-110 transition-transform">🎓</div>
                    ...
                    <a href="{{ route('admin.users.index') }}" class="p-3.5 bg-white/10 hover:bg-white/20 backdrop-blur-md rounded-2xl border border-white/10 text-center transition group hover:scale-105 cursor-pointer" style="background-color: rgba(255, 255, 255, 0.15) !important; border: 1px solid rgba(255, 255, 255, 0.25) !important; color: #ffffff !important;">
                        <div class="text-xl mb-1 group-hover:scale-110 transition-transform">👥</div>
                    ...
                    <a href="{{ route('admin.audit_logs.index') }}" class="p-3.5 bg-white/10 hover:bg-white/20 backdrop-blur-md rounded-2xl border border-white/10 text-center transition group hover:scale-105 cursor-pointer" style="background-color: rgba(255, 255, 255, 0.15) !important; border: 1px solid rgba(255, 255, 255, 0.25) !important; color: #ffffff !important;">
                        <div class="text-xl mb-1 group-hover:scale-110 transition-transform">📜</div>
                ...
                <div class="space-y-4 pt-1">
                    ...
                    @forelse($agenciesList as $agency)
                        ...
                        <div>
                            ...
                            <div class="w-full bg-slate-100 rounded-full h-2 overflow-hidden mt-1.5" style="background-color: #f1f5f9; height: 8px; border-radius: 9999px; overflow: hidden;">
                                <div class="bg-blue-600 h-2 rounded-full transition-all duration-500" style="background-color: #2563eb; height: 8px; border-radius: 9999px; width: {{ max((float)$agPercentage, 2) }}%"></div>
                            </div>
                        </div>
                    @empty
                ...
                <div class="space-y-4 pt-1">
                    ...
                    @forelse($campusList as $campus)
                        ...
                        <div>
                            ...
                            <div class="w-full bg-slate-100 rounded-full h-2 overflow-hidden mt-1.5" style="background-color: #f1f5f9; height: 8px; border-radius: 9999px; overflow: hidden;">
                                <div class="bg-sky-500 h-2 rounded-full transition-all duration-500" style="background-color: #0284c7; height: 8px; border-radius: 9999px; width: {{ max((float)$campPercentage, 2) }}%"></div>
                            </div>
                        </div>
                    @empty
