<x-app-layout>
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8">
                ...
                <div class="lg:col-span-7 space-y-3">
                    @if($isSuperAdmin)
                        <span
                            ...
                            SUPER ADMIN PEMERINTAH KOTA SURABAYA
                        </span>
                        ...
                        <p class="text-xs sm:text-sm leading-relaxed" style="color: #dbeafe !important;">
                            Pantau ekosistem magang Pemkot Surabaya secara terpusat: kuota multi-instansi dinas, integrasi
                            kemitraan perguruan tinggi, supervisi penilaian multi-role, dan jejak aktivitas audit sistem
                            secara komprehensif.
                        </p>
                    @else
                        <span
                        ...
                        <p class="text-xs sm:text-sm leading-relaxed" style="color: #dbeafe !important;">
                            Kelola verifikasi berkas pendaftaran magang dinas, alokasi kuota divisi, penugasan mentor
                            lapangan, monitoring logbook, dan penerbitan sertifikat kelulusan resmi.
                        </p>
                    @endif
                </div>
                ...
                <div class="lg:col-span-5 grid grid-cols-2 gap-3.5">
                    @if($isSuperAdmin)
                        <a href="{{ route('admin.agencies.index') }}"
                            class="p-4 sm:p-5 rounded-2xl transition-all duration-200 group shadow-sm hover:scale-[1.03] hover:shadow-md cursor-pointer block min-h-[110px]"
                            ...
                            <div class="flex items-start justify-between">
                                <div>
                                    <div class="text-sm sm:text-base font-bold" style="color: #ffffff !important;">Instansi
                                    </div>
                                    <div class="text-[11px] mt-0.5" style="color: #bfdbfe !important;">Kelola Kuota Unit
                                    </div>
                                </div>
                        ...
                        <a href="{{ route('admin.universities.index') }}"
                            ...
                            <div class="flex items-start justify-between">
                                <div>
                                    <div class="text-sm sm:text-base font-bold" style="color: #ffffff !important;">Kampus
                                    </div>
                                    <div class="text-[11px] mt-0.5" style="color: #bfdbfe !important;">Mitra MBKM</div>
                                </div>
                                <span class="text-[10px] font-bold px-2 py-0.5 rounded-full"
                        ...
                        <a href="{{ route('admin.users.index') }}"
                            ...
                            <div class="flex items-start justify-between">
                                <div>
                                    <div class="text-sm sm:text-base font-bold" style="color: #ffffff !important;">Pengguna
                                    </div>
                                    <div class="text-[11px] mt-0.5" style="color: #bfdbfe !important;">Semua Akun & Role
                                    </div>
                                </div>
                                <span class="text-[10px] font-bold px-2 py-0.5 rounded-full"
                        ...
                        <a href="{{ route('admin.audit_logs.index') }}"
                            ...
                            <div class="flex items-start justify-between">
                                <div>
                                    <div class="text-sm sm:text-base font-bold" style="color: #ffffff !important;">Log Audit
                                    </div>
                                    <div class="text-[11px] mt-0.5" style="color: #bfdbfe !important;">Rekam Jejak Sistem
                                    </div>
                                </div>
                                <span class="text-[10px] font-bold px-2 py-0.5 rounded-full"
                    ...
                    @else
                        <a href="{{ route('admin.applications.index') }}"
                            ...
                            <div class="flex items-start justify-between">
                                <div>
                                    <div class="text-sm sm:text-base font-bold" style="color: #ffffff !important;">
                                        Verifikasi</div>
                                    <div class="text-[11px] mt-0.5" style="color: #bfdbfe !important;">Berkas Pendaftar
                                    </div>
                                </div>
                                <span class="text-[10px] font-bold px-2 py-0.5 rounded-full"
                        ...
                        <a href="{{ route('admin.units.index') }}"
                            ...
                            <div class="flex items-start justify-between">
                                <div>
                                    <div class="text-sm sm:text-base font-bold" style="color: #ffffff !important;">Divisi &
                                        Kuota</div>
                                    <div class="text-[11px] mt-0.5" style="color: #bfdbfe !important;">Alokasi Slot Magang
                                    </div>
                                </div>
                                <span class="text-[10px] font-bold px-2 py-0.5 rounded-full"
                        ...
                        <a href="{{ route('admin.mentors.index') }}"
                            ...
                            <div class="flex items-start justify-between">
                                <div>
                                    <div class="text-sm sm:text-base font-bold" style="color: #ffffff !important;">Mentor
                                        Dinas</div>
                                    <div class="text-[11px] mt-0.5" style="color: #bfdbfe !important;">Pembimbing Lapangan
                                    </div>
                                </div>
                                <span class="text-[10px] font-bold px-2 py-0.5 rounded-full"
                        ...
                        <a href="{{ route('admin.certificates.index') }}"
                            ...
                            <div class="flex items-start justify-between">
                                <div>
                                    <div class="text-sm sm:text-base font-bold" style="color: #ffffff !important;">
                                        Sertifikat</div>
                                    <div class="text-[11px] mt-0.5" style="color: #bfdbfe !important;">Penerbitan Resmi
                                    </div>
                                </div>
                                <span class="text-[10px] font-bold px-2 py-0.5 rounded-full"
        ...
        @if($isSuperAdmin && isset($pendingUniversities) && $pendingUniversities->count() > 0)
            <div class="px-5 py-3 bg-amber-50 border-l-4 border-amber-500 rounded-2xl shadow-xs flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div class="flex items-start gap-3">
                    ...
                    <div>
                        ...
                        <p class="text-xs text-slate-600 mt-0.5">
                            Mahasiswa mendaftar dari kampus baru:
                            <strong>{{ $pendingUniversities->pluck('name')->implode(', ') }}</strong>. Silakan lengkapi
                            profil kampus dan buatkan akun login PIC/Admin Kampus.
                        </p>
                    </div>
                </div>
                <a href="{{ route('admin.universities.index') }}"
                    class="flex items-center justify-between gap-3 px-5 py-3 bg-amber-500 hover:bg-amber-600 rounded-2xl transition-all duration-200 shadow-sm hover:scale-[1.03] hover:shadow-md cursor-pointer shrink-0">
                    <div class="text-[13px] font-bold text-white whitespace-nowrap">Kampus Mitra MBKM</div>
                    <span class="text-[10px] font-bold px-2 py-0.5 rounded-full bg-white/20 text-white whitespace-nowrap">{{ $stats['total_universities'] ?? 0 }} Kampus</span>
                </a>
            </div>
        @endif
        ...
        <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
            ...
            <div class="bg-white p-4 sm:p-5 rounded-2xl border border-slate-100 shadow-sm hover:shadow-md transition flex flex-col justify-between"
                ...
                <div class="text-2xl font-black text-slate-900">{{ $stats['total_pending'] ?? 0 }}</div>
            ...
            <div class="bg-white p-4 sm:p-5 rounded-2xl border border-slate-100 shadow-sm hover:shadow-md transition flex flex-col justify-between"
                style="background-color: #ffffff !important; border: 1px solid #f1f5f9 !important;">
                <div class="flex items-center justify-between mb-2">
                    <span class="text-[11px] font-bold text-slate-900 uppercase tracking-wider">Diterima</span>

                </div>
                <div class="text-2xl font-black text-slate-900">{{ $stats['total_accepted'] ?? 0 }}</div>
            ...
            <div class="bg-white p-4 sm:p-5 rounded-2xl border border-slate-100 shadow-sm hover:shadow-md transition flex flex-col justify-between"
                style="background-color: #ffffff !important; border: 1px solid #f1f5f9 !important;">
                <div class="flex items-center justify-between mb-2">
                    <span class="text-[11px] font-bold text-slate-900 uppercase tracking-wider">Aktif</span>

                </div>
                <div class="text-2xl font-black text-slate-900">{{ $stats['total_active'] ?? 0 }}</div>
            ...
            <div class="bg-white p-4 sm:p-5 rounded-2xl border border-slate-100 shadow-sm hover:shadow-md transition flex flex-col justify-between"
                style="background-color: #ffffff !important; border: 1px solid #f1f5f9 !important;">
                <div class="flex items-center justify-between mb-2">
                    <span class="text-[11px] font-bold text-slate-900 uppercase tracking-wider">Lulus</span>

                </div>
                <div class="text-2xl font-black text-slate-900">{{ $stats['total_completed'] ?? 0 }}</div>
                    ...
                    <div class="flex items-center gap-3 flex-1 min-w-0">
                        ...
                        <div class="min-w-0">
                            @if($isSuperAdmin)
                                ...
                                <p class="text-xs text-slate-400 truncate">Sebaran mahasiswa magang di dinas Pemkot Surabaya
                                </p>
                            @else
                        ...
                        <a href="{{ route('admin.agencies.index') }}"
                            ...
                            <div class="flex items-start justify-between">
                                <div>
                                    ...
                                    <div class="text-[12px] font-bold mt-0.5" style="color: #2563eb !important;">Kelola Kuota Unit
                                    </div>
                                </div>
                                <span class="text-[10px] font-bold px-2 py-0.5 rounded-full"
                                    style="background-color: rgba(255, 255, 255, 0.18); color: #ffffff;">{{ $stats['total_agencies'] ?? 0 }}
                        ...
                        <div>
                            ...
                            <div class="w-full rounded-full overflow-hidden mt-1.5"
                                ...
                                <div class="h-2 rounded-full transition-all duration-500"
                                    style="background-color: #2563eb; height: 8px; border-radius: 9999px; width: {{ max((float) $itemPercentage, 2) }}%">
                                </div>
                            </div>
                        </div>
                    @empty
                        ...
                        <a href="{{ route('admin.universities.index') }}"
                            ...
                            <div class="flex items-start justify-between">
                                <div>
                                    ...
                                    <div class="text-[12px] font-bold mt-0.5" style="color: #2563eb !important;">Mitra MBKM</div>
                                </div>
                                <span class="text-[10px] font-bold px-2 py-0.5 rounded-full"
                                    style="background-color: rgba(255, 255, 255, 0.18); color: #ffffff;">{{ $stats['total_universities'] ?? 0 }}
                                    Kampus</span>
                        ...
                        <div>
                            <div class="flex items-center justify-between text-xs font-semibold mb-1.5">
                                ...
                                <span class="text-sky-700 font-bold shrink-0">{{ $campCount }} Mahasiswa <span
                                        class="text-slate-400 font-normal">({{ $campPercentage }}%)</span></span>
                            </div>
                            <div class="w-full rounded-full overflow-hidden mt-1.5"
                                style="background-color: #f1f5f9; height: 8px; border-radius: 9999px; overflow: hidden;">
                                <div class="h-2 rounded-full transition-all duration-500"
                                    style="background-color: #0284c7; height: 8px; border-radius: 9999px; width: {{ max((float) $campPercentage, 2) }}%">
                                </div>
                            </div>
                        </div>
                    @empty
