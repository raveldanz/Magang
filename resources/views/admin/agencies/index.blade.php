                        ...
                        <div class="mt-6 pt-4 border-t border-gray-100 flex items-center justify-between gap-2">
                            ...
                            @if($isSuperAdmin)
                                <div class="btn-action-group">
                                    ...
                                    @elseif($firstAdmin)
                                        <form action="{{ route('admin.impersonate', $firstAdmin->id) }}" method="POST" class="btn-action-form">
                                            @csrf
                                            <button type="submit" class="inline-flex items-center gap-1 px-2.5 py-1.5 bg-emerald-600 hover:bg-emerald-700 text-white rounded-xl text-xs font-bold transition shadow-xs cursor-pointer" title="Login As ke Akun Admin Dinas">
