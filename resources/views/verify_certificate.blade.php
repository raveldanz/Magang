...
<<<<<<< HEAD
        <div class="bg-white overflow-hidden shadow-xl rounded-2xl p-6 border-t-8 border-indigo-600">
=======
...
<<<<<<< HEAD
            <div class="mt-6 flex items-center space-x-4 bg-indigo-50 p-4 rounded-xl border border-indigo-200 shadow-sm">
                <div class="flex-shrink-0 bg-indigo-600 text-white p-3 rounded-full shadow-md">
=======
...
>>>>>>> main
                ...
                <div>
<<<<<<< HEAD
                    <span class="inline-block px-2.5 py-0.5 text-xs font-bold bg-indigo-200 text-indigo-900 rounded-full mb-1">
                        STATUS: E-SERTIFIKAT SAH & TERVERIFIKASI
                    </span>
                    <h3 class="font-extrabold text-indigo-950 text-base leading-tight">SERTIFIKAT KELULUSAN MAGANG RESMI</h3>
                    <p class="text-xs text-indigo-700 mt-0.5">Sertifikat ini diterbitkan secara resmi dan tersimpan dalam pangkalan data Pemerintah Kota Surabaya.</p>
=======
...
<<<<<<< HEAD
                        <span class="font-bold text-indigo-700">{{ $placement->application->unit->name ?? '-' }}</span>
=======
